...
// 🎯 التعديل الصحيح: استدعاء الكائن الرسمي المعتمد من جوجل لمنع انهيار السيرفر
...
// تهيئة مكتبة جوجل باستخدام الكائن الصحيح والمفتاح السري
let genAI = null;
if (API_KEY) {
...
const server = http.createServer((req, res) => {
    // إعدادات الـ CORS الكاملة لمنع أي حجب من المتصفحات والهواتف
    ...
    // [2] استقبال البيانات وتوليد المحتوى عبر حزمة جوجل المستقرة
        ...
        req.on('end', async () => {
            try {
                ...
                // صياغة الأمر الموجه لتصميم الكروت الزجاجية الفخمة
                ...
                // 🎯 استدعاء الموديل الفلاش المستقر عبر الطريقة الرسمية للحزمة
                ...
                // إرجاع تفاصيل الخطأ لتجنب تجميد الواجهة
